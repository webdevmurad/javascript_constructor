...
var model = [new _blocks.TitleBlock('Конструктор сайта на JS', {
  tag: 'h2',
  styles: {
...
}), new _blocks.TextBlock('This text', {
  styles: {
  ...
  alt: 'Это картинка'
}), new _blocks.ColumnsBlock(['Приложение на JS', 'Применяется принципы solid и ООП', 'UI своими руками'], {
  styles: {
